...
func (this *Deployments) ensureCompoundIndex(collection *mongo.Collection, indexname string, asc bool, unique bool, indexKeys ...string) error {
...
func (this *Deployments) ensureIndex(collection *mongo.Collection, indexname string, indexKey string, asc bool, unique bool) error {
	ctx, _ := this.getTimeoutContext()
	var direction int32 = -1
	if asc {
		direction = 1
...
func (this *Deployments) ensureTextIndex(collection *mongo.Collection, indexname string, indexKeys ...string) error {
	if len(indexKeys) == 0 {
